...
class GamerController extends BaseController {
    ...
    public function statistic(){
        ...
        $users_question_count = GameUserQuestions::where('status',2)->select(DB::raw('count(*) as user_count'))->pluck('user_count');
Helper::tad($users_question_count);
        $game_medium_time = 0;
        $question_medium_time = 0;
