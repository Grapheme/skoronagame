...
{{ Form::open(array('route'=>'question.store','class'=>'smart-form','id'=>'question-form','role'=>'form','method'=>'post')) }}
                            ...
                            <label class="input">
                                ...
                                <section>
                                    <label class="checkbox">
                                        {{ Form::checkbox("current[$i]",1,FALSE,array('class'=>'js-set-current-answer')) }}
