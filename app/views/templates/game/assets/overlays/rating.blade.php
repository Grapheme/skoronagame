    ...
    <div class="tabs">
        <div class="tab active">
            ...
            <p>
                ...
                Все территории распределены между игроками, начинается этап захвата земель. 
            </p>
            <p>
            ...
            <p>
                <img src="{{ asset(Config::get('site.theme_path').'/images/ico-4.png') }}">
                Этап разделен на 4 тура, в каждом из которых все игроки делают по одному ходу.
            </p>
            <p>
                <img src="{{ asset(Config::get('site.theme_path').'/images/ico-1st-place.png') }}">
                Победителем станет игрок, набравший больге всех очков.
            </p>
        </div>
    </div>
</div>
