<div id="new-password" class="popup">
    ...
    {{ Form::open(array('url'=>URL::route('profile-password-save'),'data-result'=>'password-is-new')) }}
        {{ Form::password('old_password',NULL,array('placeholder'=>'Введите пароль')) }}
        {{ Form::password('password',NULL,array('placeholder'=>'Новый пароль')) }}
        <div class="i">
        ...
        {{ Form::password('ver_password',NULL,['placeholder'=>'Повторный ввод нового пароля']) }}
